...
const validatePatchRequest = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const measureRecord = yield Measures_models_1.default.findOne({ where: { measure_uuid } });
    if (!measureRecord) {
...
exports.default = validatePatchRequest;
