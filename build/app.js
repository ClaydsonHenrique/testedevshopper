...
const validateRequestGet_1 = __importDefault(require("./middleware/validateRequestGet"));
...
app.get("/:customer_code/list", validateRequestGet_1.default, listMeasuremets_controller_1.default);
exports.default = app;
